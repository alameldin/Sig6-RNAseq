...
sed -i 's/Chr/CHROMOSOME/g' TAIR10_gtf_genes.gtf > TAIR10_gtf_genes_corID.gtf
# for indexing
mkdir ${genome_path}/STAR_index
module load STAR/2.6.0c

STAR --runThreadN 3 --runMode genomeGenerate --genomeDir ${genome_path}/STAR_index --genomeFastaFiles ${genome_path}/TAIR10_chr_all.fas --sjdbGTFfeatureExon ${genome_path}/TAIR10_gtf_genes_corID.gtf 
